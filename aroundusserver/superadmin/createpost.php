            ...
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" enctype="multipart/form-data" novalidate method="post">
                ...
                <div class="col-md-12">
                  ...
                  <input type="emailid" value="<?php echo $emailid =  $_SESSION["emailid"]; ?>" placeholder="Email ID" class="form-control" id="emailid validationCustom01" required name="emailid" required>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                  <div class="invalid-feedback">
