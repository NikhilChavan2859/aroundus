...
if(isset($_POST["submit"]))
{
  ...
  $sql = "INSERT INTO  user(name,emailid,password)VALUES('$name','$emailid','$password')";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-lg-block">AroundUs</span>
                </a>
              </div><!-- End Logo -->
                ...
                <div class="card-body">
                  ...
                  <form method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="name" class="form-control" id="yourName" minlength="5" onkeydown="return /[a-zA-Z]/i.test(event.key)" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" id="yourPassword" required>
                      <div class="invalid-feedback">Please enter a valid Password!</div>
                      <div id="message">
                        <div>Password must contain the following:</div>
                        <div id="letter" class="invalid">A lowercase letter</div>
                        <div id="capital" class="invalid">A capital (uppercase)letter</div>
                        <div id="number" class="invalid">A number</div>
                    ...
                    <div class="col-12">
                      <input class="btn btn-primary w-100" value="Submit" type="submit" name="submit">
                    </div>
