...
if(isset($_POST['update']))
{
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE message SET name='$name',emailid='$emailid', subject='$subject',message='$message' WHERE id=$id");
    ...
    <section class="section dashboard">
      <form class="row g-3 needs-validation" novalidate method="post" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>">
                ...
                <div class="col-md-12">
                  ...
                  <input value="<?php echo $subject;?>" type="text" placeholder="Subject" class="form-control" id="subject" required name="subject">
                  <div class="valid-feedback">
                    Looks good !
                  </div>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-12">
                  ...
                  <textarea value="<?php echo $message;?>" class="form-control" placeholder="Message" id="message" style="height: 100px;" required name="message"><?php echo $message;?></textarea>
                  <div class="valid-feedback">
                    Looks good !
                  </div>
                  <div class="invalid-feedback">
                ...
                <div class="text-center">
                  ...
                  <a href="viewproduct.php" class="btn btn-primary">Back</a>
