...
$message="";
if(count($_POST)>0) {
$con = mysqli_connect("sql102.ultimatefreehost.in","ltm_34029829","Rr240053","ltm_34029829_aroundus") or die('Unable To connect');
$result = mysqli_query($con,"SELECT * FROM user WHERE emailid='" . $_POST["emailid"] . "' and password = '". $_POST["password"]."'");
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login to Your User Account</h5>
